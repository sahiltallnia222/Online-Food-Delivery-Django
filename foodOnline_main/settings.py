...
# this is used in production mode to get all the static files at one place that is static folder in base dir
...
EMAIL_USE_TLS=True
DEFAULT_FROM_EMAIL='FoodOnline Marketplace <sahiltallnia222@gmail.com>'